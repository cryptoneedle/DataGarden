...
public class SelectSourceService {
    ...
    public SourceDatabase databaseCheck(SourceDatabaseKey id) throws EntityNotFoundException {
        return sourceDatabaseRepository.findById(id).orElseThrow(() -> new EntityNotFoundException("SourceDatabase", id.toString()));
    }
    ...
    public SourceTable tableCheck(SourceTableKey id) throws EntityNotFoundException {
        return sourceTableRepository.findById(id).orElseThrow(() -> new EntityNotFoundException("SourceTable", id.toString()));
    }
    ...
    public SourceColumn columnCheck(SourceColumnKey id) throws EntityNotFoundException {
        return sourceColumnRepository.findById(id).orElseThrow(() -> new EntityNotFoundException("SourceColumn", id.toString()));
    }
    ...
    public SourceDimension dimensionCheck(SourceDimensionKey id) throws EntityNotFoundException {
        return sourceDimensionRepository.findById(id).orElseThrow(() -> new EntityNotFoundException("SourceDimension", id.toString()));
    }
