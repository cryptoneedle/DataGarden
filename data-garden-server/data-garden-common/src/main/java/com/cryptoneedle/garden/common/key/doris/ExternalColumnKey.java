...
public class ExternalColumnKey implements Serializable {
    ...
    public ExternalTableKey externalTableKey() {
        return ExternalTableKey.builder().catalog(this.catalog).database(this.database).table(this.table).build();
    }
}