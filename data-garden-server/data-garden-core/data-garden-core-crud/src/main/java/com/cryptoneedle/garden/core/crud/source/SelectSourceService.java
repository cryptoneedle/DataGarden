    ...
    public List<MapTree<Object>> tree() {
        ...
        sourceTreeDtos.addAll(databasesEnabled()
                ...
                .map(database -> new SourceTreeDto()
                        .setId("catalog-" + database.getId().getCatalogName() + ":database-" + database.getId().getDatabaseName())
        ...
        sourceTreeDtos.addAll(tablesEnabled()
                ...
                .map(table -> new SourceTreeDto()
                        .setId("catalog-" + table.getId().getCatalogName() + ":database-" + table.getId().getDatabaseName() + ":table-" + table.getId().getTableName())
                        .setParentId("catalog-" + table.getId().getCatalogName() + ":database-" + table.getId().getDatabaseName())
