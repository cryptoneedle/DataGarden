...
public class SelectStandardService {
    ...
    public StandardTable tableCheck(DorisTableKey id) throws EntityNotFoundException {
        return standardTableRepository.findById(id)
                                      .orElseThrow(() -> new EntityNotFoundException("StandardTable", id.toString()));
    }
    ...
    public StandardColumn columnCheck(DorisColumnKey id) throws EntityNotFoundException {
        return standardColumnRepository.findById(id)
                                       .orElseThrow(() -> new EntityNotFoundException("StandardColumn", id.toString()));
    }
