...
public class SelectDwdService {
    ...
    public DwdTable tableCheck(DorisTableKey id) throws EntityNotFoundException {
        return dwdTableRepository.findById(id)
                                 .orElseThrow(() -> new EntityNotFoundException("DwdTable", id.toString()));
    }
    ...
    public DwdColumn columnCheck(DorisColumnKey id) throws EntityNotFoundException {
        return dwdColumnRepository.findById(id)
                                  .orElseThrow(() -> new EntityNotFoundException("DwdColumn", id.toString()));
    }
