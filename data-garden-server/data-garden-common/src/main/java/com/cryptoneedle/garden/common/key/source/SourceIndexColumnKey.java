...
public class SourceIndexColumnKey implements Serializable {
    ...
    public SourceIndexKey sourceIndexKey() {
        return SourceIndexKey.builder().catalog(this.catalog).database(this.database).table(this.table).index(this.index).build();
    }
